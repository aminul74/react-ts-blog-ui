...
const AboutSection: React.FC = () => {
    return (
        <section className="flex items-center py-10 bg-gray-900 xl:h-screen md:h-screen font-poppins">
            <div className="justify-center w-full max-w-screen-6xl py-4 mx-auto lg:py-4 md:px-6">
                <div className="flex flex-wrap">
                    ...
                    <div className="w-full px-4 mb-10 lg:w-1/2 lg:mb-0">
                        ...
                        <p className="mt-6 mb-10 text-base leading-7 text-gray-500 dark:text-gray-400">
                            ...
                            sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniamLorem ipsum
                            dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna
                            aliqua. Ut enim ad minim veniamLorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod
                            tempor
                        </p>
                        <a
                            href="#"
